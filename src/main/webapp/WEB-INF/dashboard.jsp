            ...
            <div class="card stat-card primary h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <div class="kpi-number text-primary"><%= kpis.get("totalUsuarios") %>
                            </div>
        ...
        <div class="col-xl-2 col-md-4 col-sm-6 mb-3">
            <div class="card stat-card success h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <div class="kpi-number text-success"><%= kpis.get("totalViajes") %>
                            </div>
        ...
        <div class="col-xl-2 col-md-4 col-sm-6 mb-3">
            <div class="card stat-card info h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <div class="kpi-number text-info"><%= kpis.get("totalReservas") %>
                            </div>
        ...
        <div class="col-xl-2 col-md-4 col-sm-6 mb-3">
            <div class="card stat-card warning h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <div class="kpi-number text-warning"><%= kpis.get("viajesActivos") %>
                            </div>
        ...
        <div class="col-xl-2 col-md-4 col-sm-6 mb-3">
            <div class="card stat-card dark h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <div class="kpi-number text-dark"><%= kpis.get("viajesCancelados") %>
                            </div>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        <div class="text-center p-3 border rounded">
                            <div class="h4 fw-bold text-primary"><%= estadisticasUsuarios.get("totalConductores") %>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="text-center p-3 border rounded">
                            <div class="h4 fw-bold text-success"><%= estadisticasUsuarios.get("totalPasajeros") %>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="text-center p-3 border rounded">
                            <div class="h4 fw-bold text-info"><%= estadisticasUsuarios.get("totalAdmins") %>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="text-center p-3 border rounded">
                            <div class="h4 fw-bold text-warning"><%= estadisticasUsuarios.get("totalUsuarios") %>
                            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-sm table-hover">
                        ...
                        <tr>
                            ...
                            <td><small><%= reserva.getPasajero().getNombre() %>
                            </small></td>
                            <td>
                                <%
                        ...
                        <div class="list-group list-group-flush">
                            ...
                            <div class="list-group-item px-0 border-0">
                                <div class="d-flex w-100 justify-content-between align-items-center">
                                    <div>
                                        <h6 class="mb-1 small"><%= viaje.getOrigen() %> → <%= viaje.getDestino() %>
                                        </h6>
                    ...
                    <div class="dashboard-section p-4 h-100">
                        ...
                        <div class="list-group list-group-flush">
                            ...
                            <div class="list-group-item px-0 border-0">
                                <div class="d-flex w-100 justify-content-between align-items-center">
                                    <div>
                                        <h6 class="mb-1 small"><%= user.getNombre() %> <%= user.getApellido() %>
                                        </h6>
                                        <p class="mb-1 small text-muted"><%= user.getCorreo() %>
                                        </p>
                                    </div>
